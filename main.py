...
def example():
  ...
  print(positions.shape) # Format is position[time_index, [x,y,z], bodyNum]
  ...
  # Delete all isntances of bodies
...
def main():
  ...
  example() # You can read code to better udnerstand
